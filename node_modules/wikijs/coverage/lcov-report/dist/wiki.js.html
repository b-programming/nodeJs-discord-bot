...
&nbsp;
var _wikiMarkupParser = require('./wiki-markup-parser');
&nbsp;
var _wikiMarkupParser2 = _interopRequireDefault(_wikiMarkupParser);
&nbsp;
/**
 * @namespace
...
&nbsp;
			return new _Promise(function (resolve, reject) {
				_requestPromise2['default'].get({
					...
					qs: _underscore2['default'].extend(params, {
						format: 'json',
						action: 'query'
					}),
					headers: {
...
&nbsp;
   ...
   */
		...
		value: function random() {
			var _this4 = this;
&nbsp;
			var limit = arguments.length &lt;= 0 || arguments[0] === undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >1 </span>: arguments[0];
&nbsp;
			return new _Promise(function (resolve, reject) {
				_this4.api({
					list: 'random',
					...
					return resolve(_underscore2['default'].pluck(res.query.random, 'title'));
				})['catch'](reject);
			});
		}
&nbsp;
...
&nbsp;
   ...
   */
		...
		value: function geoSearch(lat, lon) {
			var _this6 = this;
&nbsp;
			var radius = arguments.length &lt;= 2 || <span class="branch-1 cbranch-no" title="branch not covered" >arguments[2] === undefined </span>? 1000 : <span class="branch-1 cbranch-no" title="branch not covered" >arguments[2];</span>
			// 1km
			return new _Promise(function (resolve, reject) {
				_this6.api({
					list: 'geosearch',
					...
					return resolve(_underscore2['default'].pluck(res.query.geosearch, 'title'));
				})['catch'](reject);
			});
		}
	}]);
...
&nbsp;
			return new _Promise(function (resolve, reject) {
				_this11.wiki.api({
					...
					return resolve(_underscore2['default'].pluck(res.query.pages[_this11.pageid].extlinks, '*'));
				})['catch'](reject);
			});
		}
&nbsp;
   ...
   */
		...
		value: function links() {
			var _this12 = this;
&nbsp;
			var aggregated = arguments.length &lt;= 0 || <span class="branch-1 cbranch-no" title="branch not covered" >arguments[0] === undefined </span>? true : <span class="branch-1 cbranch-no" title="branch not covered" >arguments[0];</span>
			var limit = arguments.length &lt;= 1 || <span class="branch-1 cbranch-no" title="branch not covered" >arguments[1] === undefined </span>? 100 : <span class="branch-1 cbranch-no" title="branch not covered" >arguments[1];</span>
&nbsp;
			var pagination = this.wiki.pagination({
				...
				return _underscore2['default'].pluck(res.query.pages[_this12.pageid].links, 'title');
			});
...
&nbsp;
			var pagination = this.wiki.pagination({
				...
				return _underscore2['default'].pluck(res.query.pages[_this13.pageid].categories, 'title');
			});
			<span class="missing-if-branch" title="else path not taken" >E</span>if (aggregated) {
				return this.wiki.aggregatePagination(pagination);
			} else {
...
&nbsp;
			return new _Promise(function (resolve, reject) {
				_this15.wiki.api({
					...
					return resolve((0, _wikiMarkupParser2['default'])(res.query.pages[_this15.pageid].revisions[0]['*']));
				})['catch'](reject);
			});
		}
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue Apr 26 2016 20:54:07 GMT-0500 (CDT)</div>
</div>
